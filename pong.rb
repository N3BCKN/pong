...
class Ball
  ...
  def draw
    @shape = Square.new(x: @x, y: @y, size: HEIGHT, color: 'green')
    # @shage = Image.new('duck.png', x: @x, y: @y, width: 80, height: 45, z: 10 )
  end
...
# image = Image.new('duck.png', x: 400, y: 200, width: 80, height: 45, z: 10 )
